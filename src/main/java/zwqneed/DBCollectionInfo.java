...
public class DBCollectionInfo {
	public final static String CRAWLER_DB = "ghcrawlerV3";
	public final static String REPO_COLLECTION = "repository";
	public final static String PULL_COLLECTION = "pullscp";
	public final static String COMMIT_COLLECTION = "commitsbyapi";
